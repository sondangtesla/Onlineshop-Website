                    ...
                    <form class="form-horizontal" enctype="multipart/form-data" wire:submit.prevent="updateProduct">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4" wire:ignore>
                                <textarea class="form-control" id="short_description" placeholder="description" wire:model="short_description"></textarea>
    ...
    $(function(){
        tinymce.init({
            ...
            setup:function(editor){
                editor.on('Change', function(e){
                    tinyMCE.triggerSave();
                    var sd_data = $('textarea#short_description').val();
        ...
        tinymce.init({
            ...
            setup:function(editor){
                editor.on('Change', function(e){
                    tinyMCE.triggerSave();
                    var d_data = $('textarea#description').val();
