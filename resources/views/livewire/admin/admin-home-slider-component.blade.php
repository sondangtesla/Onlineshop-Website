                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="" onclick="confirm('Are you sure want to delete this slider?') || event.stopImmediatePropagation()" wire:click.prevent="deleteSlide({{$slider->id}})" style="margin-left: 10px;"> <i class="fa fa-times fa-2x text-danger"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
