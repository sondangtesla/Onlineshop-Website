...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sitebar">
            ...
            <div class="widget mercado-widget filter-widget">
                <h2 class="widget-title">Kemasan</h2>
                <div class="widget-content">
                    <ul class="list-style inline-round ">
                        <li class="list-item"><a class="filter-link active" href="#">100 gr</a></li>
                        <li class="list-item"><a class="filter-link " href="#">200 gr</a></li>
                        <li class="list-item"><a class="filter-link " href="#">300 gr</a></li>
                        <li class="list-item"><a class="filter-link " href="#">500 gr</a></li>
                        <li class="list-item"><a class="filter-link " href="#">1 kg</a></li>
                    </ul>
                        ...
                        <li class="product-item">
                            <div class="product product-widget-style">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="wrap-price"><span class="product-price">@currency($p_product->regular_price)</span></div>
                                </div>
                            </div>
                        </li>
                        @endforeach
