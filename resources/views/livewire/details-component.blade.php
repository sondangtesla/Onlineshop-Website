                    ...
                    <div class="detail-info">
                        ...
                        @if($product->sale_price > 0 && $sale->status == 1 && $sale->sale_date > Carbon\Carbon::now())
                            <div class="wrap-price">
                                ...
                                <del><span class="product-price regprice">@currency($product->regular_price)</span></del>
                            </div>
                        @else
                            <div class="wrap-price">
                                <span class="product-price">@currency($product->regular_price)</span>
                            </div>
                        @endif
                        ...
                        <!-- <div class="certified">
                            <ul>
                                <li>
                                <label for="exampleFormControlInput1" class="form-label" style="min-width: 50px">Kemasan: </label>
                                <select class="form-select" aria-label="Default select example" style="border: 1px; min-width: 100px">
                                ...
                                <li>
                                <label for="exampleFormControlInput1" class="form-label" style="min-width: 50px">Varian Gilingan: </label>
                                <select class="form-select" aria-label="Default select example" style="border: 1px; min-width: 100px">
                                    <option selected>Biji</option>
                                    <option value="100 gr">Kasar</option>
                                    <option value="200 gr">Sedang</option>
                                    <option value="300 gr">Halus</option>
                                </select>
                                </li>
                            </ul>
                        </div> -->
                        <div class="wrap-butons">
                            @if($product->sale_price > 0 && $sale->status == 1 && $sale->sale_date > Carbon\Carbon::now())
                                ...
                                <div class="wrap-btn">
                                <a href="" wire:click.prevent="addToWishList({{$product->id}}, '{{$product->name}}', {{$product->sale_price}})" class="btn btn-wishlist">Add Wishlist</a>
                            </div>
                            @else
                                        ...
                                        <ol class="commentlist">
                                            ...
                                            <li class="comment byuser comment-author-admin bypostauthor even thread-even depth-1" id="li-comment-20">
                                                <div id="comment-20" class="comment_container"> 
                                                    <img alt="{{$orderItem->order->user->name}}" src="{{asset('assets/images/profile')}}/{{$orderItem->order->user->profile->image}}" height="80" width="80" style="border-radius: 50%;">
                                                    <div class="comment-text">
                                                        ...
                                                        <p class="meta"> 
                                                            ...
                                                            <time class="woocommerce-review__published-date" datetime="2008-02-14 20:00" >{{Carbon::parse($orderItem->review->created_at)->format('d F Y g:i A')}}</time>
                                                        </p>
                            ...
                            <li class="product-item">
                                <div class="product product-widget-style">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="wrap-price"><span class="product-price">@currency($product->regular_price)</span></div>
                                    </div>
                                </div>
                            </li>
                            @endforeach
