			...
			<div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container " data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}'>
				...
				<div class="product product-style-2 equal-elem ">
					...
					<div class="product-info">
						...
						<div class="wrap-price"><ins><p class="product-price">@currency($sproduct->sale_price)</p></ins> <del><p class="product-price">@currency($sproduct->regular_price)</p></del></div>
					</div>
				</div>
				@endforeach
								...
								@foreach ($lproducts as $lproduct)
									<div class="product product-style-2 equal-elem ">
										...
										<div class="product-info">
											...
											<div class="wrap-price"><span class="product-price">@currency($lproduct->regular_price)</span></div>
										</div>
									</div>
								@endforeach
								...
								@endphp
									...
									<div class="product product-style-2 equal-elem ">
										...
										<div class="product-info">
											...
											@if($sproducts->count() > 0 && $sale->status == 1 && $sale->sale_date > Carbon\Carbon::now())
											<div class="wrap-price"><ins><p class="product-price">@currency($c_product->sale_price)</p></ins> 
												<del>
														<p class="product-price">@currency($c_product->regular_price)</p>
												</del>
											</div>
											@else
											<div class="wrap-price"><ins><p class="product-price">@currency($c_product->regular_price)</p></ins></div>
											@endif
										</div>
									</div>
									@endforeach
