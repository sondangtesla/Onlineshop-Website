...
<body>
    ...
    <table style="width: 600px; text-align:right">
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="3" style="border-top: 1px solid #ccc;"></td>
                    <td style="font-size: 15px; font-weight:bold; border-top: 1px solid #ccc;">Tax : Rp {{$order->tax}}</td>
                </tr>
                <tr>
                    <td colspan="3" style="border-top: 1px solid #ccc;"></td>
                ...
                <tr>
                    <td colspan="3" style="border-top: 1px solid #ccc;"></td>
                    <td style="font-size: 22px; font-weight:bold; border-top: 1px solid #ccc;">Total : Rp {{$order->total}}</td>
                </tr>
            </tbody>
    </table>
</body>
